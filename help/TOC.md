...
+ Introduzione a [!DNL Marketo Measure] {#introduction-to-marketo-measure}
   + Risorse panoramica {#overview-resources}
      + [Marketing Attribution](introduction-to-marketo-measure/overview-resources/marketing-attribution.md)
      + [Modelli di attribuzione [!DNL Marketo Measure]](introduction-to-marketo-measure/overview-resources/marketo-measure-attribution-models.md)
      + [Framework [!DNL Marketo Measure]](introduction-to-marketo-measure/overview-resources/marketo-measure-framework.md)
...
+ [!DNL Marketo Measure] Tracciamento di {#marketo-measure-tracking}
   + Impostazione del tracciamento {#setting-up-tracking}
      + [Best practice per l&#39;implementazione di [!DNL Marketo Measure] JavaScript](marketo-measure-tracking/setting-up-tracking/best-practices-for-implementing-marketo-measure-javascript.md)
      + [Aggiunta dello script  [!DNL Marketo Measure]  in corso](marketo-measure-tracking/setting-up-tracking/adding-marketo-measure-script.md)
      + [Aggiunta dello script  [!DNL Marketo Measure]  tramite Google Tag Manager](marketo-measure-tracking/setting-up-tracking/adding-marketo-measure-script-via-google-tag-manager.md)
      ...
      + Aggiunta dello script [!DNL Marketo Measure] a provider di moduli diversi {#adding-marketo-measure-script-to-different-form-providers}
         + [Aggiunta di  [!DNL Marketo Measure] JavaScript a Pardot](marketo-measure-tracking/setting-up-tracking/adding-marketo-measure-script-to-different-form-providers/adding-marketo-measure-javascript-to-pardot.md)
         + [Aggiunta dello script  [!DNL Marketo Measure]  a Lightbox Forms](marketo-measure-tracking/setting-up-tracking/adding-marketo-measure-script-to-different-form-providers/adding-marketo-measure-script-to-lightbox-forms.md)
         + [Aggiunta di  [!DNL Marketo Measure] script alle pagine Sitecore](marketo-measure-tracking/setting-up-tracking/adding-marketo-measure-script-to-different-form-providers/adding-marketo-measure-script-to-sitecore-pages.md)
         + [Aggiunta dello script  [!DNL Marketo Measure]  a Uberflip Forms in corso](marketo-measure-tracking/setting-up-tracking/adding-marketo-measure-script-to-different-form-providers/adding-marketo-measure-script-to-uberflip-forms.md)
         + [Aggiunta di  [!DNL Marketo Measure]  a Forms Act-On](marketo-measure-tracking/setting-up-tracking/adding-marketo-measure-script-to-different-form-providers/adding-marketo-measure-to-act-on-forms.md)
         + [Aggiunta di  [!DNL Marketo Measure]  a Hubspot](marketo-measure-tracking/setting-up-tracking/adding-marketo-measure-script-to-different-form-providers/adding-marketo-measure-to-hubspot.md)
         + [Aggiunta di  [!DNL Marketo Measure]  alle pagine di destinazione di Marketo](marketo-measure-tracking/setting-up-tracking/adding-marketo-measure-script-to-different-form-providers/adding-marketo-measure-to-marketo-landing-pages.md)
         ...
         + [Connessione in corso  [!DNL Marketo Measure]  a Gestione script per l&#39;annullamento della remissione](marketo-measure-tracking/setting-up-tracking/adding-marketo-measure-script-to-different-form-providers/connecting-marketo-measure-to-unbounce-script-manager.md)
      ...
      + [Esclusione di  [!DNL Marketo Measure]  da Forms specifici](marketo-measure-tracking/setting-up-tracking/excluding-marketo-measure-from-specific-forms.md)
...
+ Configurazione e configurazione {#configuration-and-setup}
   + Guida introduttiva a [!DNL Marketo Measure] {#getting-started-with-marketo-measure}
      ...
      + [Spiegazione delle posizioni e della generazione dei punti di contatto tra BT e  [!DNL BATs]](configuration-and-setup/getting-started-with-marketo-measure/explanation-of-touchpoint-positions-and-generation-across-bts-and-bats.md)
   ...
   + [!DNL Marketo Measure] e Salesforce {#marketo-measure-and-salesforce}
      + [Installazione e configurazione del pacchetto Salesforce [!DNL Marketo Measure]](configuration-and-setup/marketo-measure-and-salesforce/marketo-measure-salesforce-package-installation-and-set-up.md)
...
+ Tracciamento dei canali e configurazione {#channel-tracking-and-setup}
...
+ Connessioni API {#api-connections}
   + Utilizzo delle connessioni API di [!DNL Marketo Measure] {#utilizing-marketo-measures-api-connections}
      ...
      + [Parametri [!DNL Marketo Measure]](api-connections/utilizing-marketo-measures-api-connections/marketo-measure-parameters.md)
      + [API FACEBOOK](api-connections/utilizing-marketo-measures-api-connections/facebook-api.md)
      + [Integrazione di [!DNL LinkedIn]](api-connections/utilizing-marketo-measures-api-connections/linkedin-integration.md)
      + [Informazioni sull&#39;assegnazione di tag  [!DNL Marketo Measure] AdWords](api-connections/utilizing-marketo-measures-api-connections/understanding-marketo-measure-adwords-tagging.md)
...
+ Spesa marketing {#marketing-spend}
   + Gestione spese {#spend-management}
      + [Metodi di gestione della spesa](marketing-spend/spend-management/spend-management-methods.md)
      + [Costi canale di marketing](marketing-spend/spend-management/marketing-channel-costs.md)
...
+ Funzionalità avanzate [!DNL Marketo Measure] {#advanced-marketo-measure-features}
   ...
   + Attribuzione attività {#activities-attribution}
      ...
      + [Attribuzione attività [!DNL Salesforce]](advanced-marketo-measure-features/activities-attribution/salesforce-activities-attribution.md)
   ...
   + Importo ricavi personalizzato {#custom-revenue-amount}
      ...
      + [Utilizzo di Data Loader per aggiornare [!DNL Marketo Measure] il campo importo personalizzato](advanced-marketo-measure-features/custom-revenue-amount/using-data-loader-to-update-marketo-measure-custom-amount-field.md)
   + Visualizza tramite attribuzione {#view-through-attribution}
      + [Domande frequenti sulla visualizzazione di [!DNL Marketo Measure] tramite attribuzione](advanced-marketo-measure-features/view-through-attribution/marketo-measure-view-through-attribution-faq.md)
   ...
   + Test A/B {#a-b-testing}
      + [Configurazione e reporting dei test A/B](advanced-marketo-measure-features/a-b-testing/a-b-testing-set-up-and-reporting.md)
      + [Configurazione dell&#39;integrazione dei test A/B di  [!DNL Marketo Measure] &#x200B;](advanced-marketo-measure-features/a-b-testing/configuring-the-marketo-measure-a-b-test-integration.md)
...
+ [!DNL Marketo Measure] e Adobe {#marketo-measure-and-adobe}
   + [Integrazioni [!DNL Marketo Measure] con Adobe Analytics](marketo-measure-and-adobe/marketo-measure-integrations-with-adobe-analytics.md)
   + [Integrazioni [!DNL Marketo Measure] con Adobe Launch](marketo-measure-and-adobe/marketo-measure-integrations-with-adobe-launch.md)
...
+ [!DNL Marketo Measure] e Dynamics {#marketo-measure-and-dynamics}
   ...
   + Reporting Dynamics {#dynamics-reporting}
      + [Report azionari e dashboard in [!DNL Dynamics]](marketo-measure-and-dynamics/dynamics-reporting/stock-reports-and-dashboards-in-dynamics.md)
+ [!DNL Marketo Measure] e Marketo {#marketo-measure-and-marketo}
   + Integrazioni [!DNL Marketo Measure] con Marketo {#marketo-measure-integrations-with-marketo}
      + [Configura connessione [!DNL Marketo] &#x200B;](marketo-measure-and-marketo/marketo-measure-integrations-with-marketo/set-up-marketo-connection.md)
      ...
      + [Integrazione Marketo Engage People](marketo-measure-and-marketo/marketo-measure-integrations-with-marketo/marketo-engage-people-integration.md)
...
+ [!DNL Marketo Measure] reporting Salesforce {#marketo-measure-salesforce-reporting}
   + Nuovi tipi di report {#new-report-types}
      + [Creazione di tipi di report personalizzati [!DNL Marketo Measure] &#x200B;](marketo-measure-salesforce-reporting/new-report-types/creating-custom-marketo-measure-report-types.md)
...
+ [!DNL Marketo Measure] Data Warehouse {#marketo-measure-data-warehouse}
   + [Data Warehouse accesso - Account Reader](marketo-measure-data-warehouse/data-warehouse-access-reader-account.md)
...
+ Modelli report BI {#bi-report-templates}
   + [Modello di report [!DNL Marketo Measure] - Power BI](bi-report-templates/marketo-measure-report-template-power-bi.md)
   + [Modello report [!DNL Marketo Measure] - Tableau](bi-report-templates/marketo-measure-report-template-tableau.md)
...
+ Varie {#miscellaneous}
   + Altre risorse correlate {#other-related-resources}
      + [Manutenzione di [!DNL Marketo Measure]](miscellaneous/other-related-resources/marketo-measure-maintenance.md)
      + [Elenco risorse [!DNL Marketo Measure]](miscellaneous/other-related-resources/marketo-measure-resource-list.md)
      + [Integrazione tracciamento chiamate](miscellaneous/other-related-resources/call-tracking-integration.md)
      + [Differenza tra una conversione Google Analytics e un Buyer Touchpoint](miscellaneous/other-related-resources/difference-between-a-google-analytics-conversion-and-a-buyer-touchpoint.md)
      + [Parametro di tracciamento e-mail](miscellaneous/other-related-resources/email-tracking-parameter.md)
      + [Concessione dell&#39;accesso [!DNL Salesforce] al supporto [!DNL Marketo Measure] in corso](miscellaneous/other-related-resources/granting-salesforce-access-to-marketo-measure-support.md)
