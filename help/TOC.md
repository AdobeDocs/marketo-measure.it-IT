...
+ [!DNL Marketo Measure] Tracciamento {#marketo-measure-tracking}
   + Impostazione del tracciamento {#setting-up-tracking}
      ...
      + [Sincronizzazione cookie ritardata](marketo-measure-tracking/setting-up-tracking/delayed-cookie-sync.md)
+ Configurazione e configurazione {#configuration-and-setup}
   ...
   + Test sandbox {#sandbox-testing}
      + [Verifica di [!DNL Marketo Measure] Integrazione con una sandbox Salesforce](configuration-and-setup/sandbox-testing/testing-the-marketo-measure-integration-with-a-salesforce-sandbox.md)
...
+ [!DNL Marketo Measure] Interfaccia utente Discover {#marketo-measure-discover-ui}
   + Dashboard {#dashboards}
      + [Documentazione del dashboard per Percorso coorte](marketo-measure-discover-ui/dashboards/cohort-journey-dashboard-documentation.md)
      + [Documentazione di Passport Dashboard](marketo-measure-discover-ui/dashboards/passport-dashboard-documentation.md)
      + [Documentazione di Snapshot Dashboard](marketo-measure-discover-ui/dashboards/snapshot-dashboard-documentation.md)
