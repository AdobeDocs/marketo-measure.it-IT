    ...
    <tr>
      ...
      <td>
        <ul>
          ...
          <li>
            <strong>Riepilogo ROI parole chiave e Creative:</strong>Obsoleto (vedi sotto)</li>
        </ul>
      </td>
    </tr>
    <tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        <p>
          <strong>Riepilogo parole chiave e ROI Creative</strong>
        </p>
      </td>
      <td>
...
* **Tipo data, metrica, Dimension, Raggruppa per**: queste impostazioni sono ora predefinite per ogni dashboard per ottimizzare la consegna insight. Le specifiche dettagliate sono accessibili tramite descrizioni e documentazione di accompagnamento.
* **Origine campagna**
* **ID e nome account**: in fase di revisione.

## Nuovi miglioramenti e aggiunte {#new-additions-and-improvements}

Le nuove funzioni sono disponibili nell&#39;articolo [Informazioni di base sulla dashboard](/help/discover-dashboard-basics.md){target="_blank"}.
