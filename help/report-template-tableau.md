...
![È necessario aggiornare i dati di connessione esistenti al Snowflake specifico](assets/marketo-tableau-7.png)

## Connessione dati {#data-connection}

Devi impostare una connessione dati all’istanza Snowflake. A questo scopo, è necessario specificare il nome del server insieme al nome utente e alla password. I dettagli su dove trovare queste informazioni e reimpostare la password, se necessario, sono documentati [qui](/help/data-warehouse-access-reader-account.md){target="_blank"}.

![Devi impostare una connessione dati all&#39;istanza di Snowflake.](assets/marketo-tableau-5.png)
...
![Sono state applicate alcune trasformazioni ai dati in Tableau](assets/marketo-tableau-1.png)

![Sono state applicate alcune trasformazioni ai dati in Tableau](assets/marketo-tableau-2.png)
...
![Per aggiungere le funzionalità di conversione della valuta ai calcoli nel modello, abbiamo](assets/marketo-tableau-4.png)
...
![In alcune posizioni due tabelle di Snowflake hanno](assets/marketo-tableau-3.png)
...
![Nella colonna CATEGORY sono elencati il numero di categoria e la colonna SEGMENTNAME](assets/marketo-tableau-13.png)
...
![I nomi possono essere aggiornati in due modi. La prima opzione è to](assets/marketo-tableau-14.png)

L&#39;altra opzione consiste nel rinominare le colonne direttamente nella tabella [!DNL Tableau].

![L&#39;altra opzione consiste nel rinominare le colonne direttamente in](assets/marketo-tableau-9.png)

## Modello di dati {#data-model}

Fai clic sull’immagine seguente per la versione di dimensioni intere.

[![Fai clic sull’immagine seguente per la versione di dimensioni intere.](assets/marketo-tableau-8.png)](assets/tableau-model-1.png){target="_blank"}
...
![Entrambe le dimensioni Costi e Punti di contatto condividono le dimensioni Canale e Campagna. Tableau](assets/marketo-tableau-10.png)
...
![Convertire il valore dalla valuta aziendale al valore selezionato nella valuta aziendale](assets/marketo-tableau-11.png)
...
![Le misure di conversione della valuta in questo modello sostituiscono un valore di 1,0](assets/marketo-tableau-12.png)
...
![Le definizioni sono state aggiunte al modello Tableau per i parametri, personalizzato](assets/marketo-tableau-15.png)

Per visualizzare le definizioni per le colonne provenienti direttamente da [!DNL Snowflake], consulta la [documentazione del data warehouse](/help/data-warehouse-schema.md){target="_blank"}.
