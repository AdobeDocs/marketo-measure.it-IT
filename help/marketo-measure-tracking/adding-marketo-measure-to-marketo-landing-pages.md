---
description: Aggiunta di  [!DNL Marketo Measure]  alle pagine di destinazione di Marketo per gli utenti di Marketo Measure
...
1. Fai clic su **[!UICONTROL Save]**.
   ...
   ![1. Fare clic su Salva.](assets/adding-pages-1.png)
