---
description: '''[!DNL Marketo Measure] Panoramica di Ultimate - [!DNL Marketo Measure]'''
...
![Livelli Marketo Measure 1-3](assets/marketo-overview-1.png)
...
![Gli addetti al marketing devono inserire i propri dati B2B (ad esempio, Account, Opportunità,](assets/marketo-overview-2.png)
...
![Marketo Measure Ultimate imposta la valuta predefinita su USD fino al](assets/marketo-overview-7.png)
...
![Dati per una determinata entità (ad esempio, Account) da un dato dato dati](assets/marketo-overview-6.png)
...
![Le regole dei punti di contatto dei membri della campagna e le regole dei punti di contatto delle attività sono specifiche per il set di dati.](assets/marketo-overview-5.png)

![Le regole dei punti di contatto dei membri della campagna e le regole dei punti di contatto delle attività sono specifiche per il set di dati.](assets/marketo-overview-8.png)
