...
1. Per iniziare a configurare le attività di Marketo, passa a **Account personale** > **Impostazioni** > **Attività**.
   ...
   ![1. Per iniziare a configurare le attività di Marketo, passa a Impostazioni account personale](assets/marketo-engage-activities-01.png)

   ![1. Per iniziare a configurare le attività di Marketo, passa a Impostazioni account personale](assets/marketo-engage-activities-02.png)
...
1. Fare clic sul menu a discesa in [!UICONTROL Select Activities Types] per iniziare a scegliere i vari tipi.
   ...
   ![1. Per iniziare, fai clic sul menu a discesa in Seleziona tipi di attività](assets/marketo-engage-activities-03.png)
...
1. In primo luogo, a seconda del tipo di attività, potrebbe essere necessario impostare un nome della campagna [!DNL Marketo Measure] che può essere utilizzato successivamente per la mappatura del canale. I nomi delle campagne [!DNL Marketo Measure] possono essere riutilizzati in più regole. Questo consente di avere nomi più ampi che possono essere utilizzati in una regola a canale singolo. Non tutti i tipi di attività contengono un programma Marketo, pertanto è necessario specificare un nome come primo passaggio.
   ...
   ![Di seguito è riportato un esempio dell&#39;aspetto di questo passaggio aggiuntivo:](assets/marketo-engage-activities-05.png)
...
1. Nell’esempio &quot;Change Score&quot; (Modifica punteggio), è necessario inserire il nome di una campagna poiché tali informazioni vengono estratte dal programma Marketo. Ora crea l’espressione della regola. In questo esempio, selezionare il campo &quot;[!UICONTROL New Value]&quot; con un operatore di &quot;[!UICONTROL is greater than]&quot; con un valore di 90.
   ...
   ![È possibile espandere le regole e aggiungere ulteriori filtri o criteri](assets/marketo-engage-activities-06.png)

   ![È possibile espandere le regole e aggiungere ulteriori filtri o criteri](assets/marketo-engage-activities-07.png)
...
1. Infine, scegli cosa utilizzare come data del punto di contatto. Tutti i campi data o data/ora disponibili vengono visualizzati qui da Marketo. A meno che tu non abbia campi data personalizzati, vedi &quot;[!UICONTROL Activity Date]&quot;.
   ...
   ![1. Infine, scegli cosa utilizzare come data del punto di contatto. Tutti disponibili](assets/marketo-engage-activities-08.png)

1. Assicurarsi di fare clic su **[!UICONTROL Save As Draft]** lungo il percorso in modo da non perdere le modifiche.

   ![1. Assicurati di fare clic su Salva come bozza durante il percorso](assets/marketo-engage-activities-09.png)

1. Passare alla scheda **[!UICONTROL Attribute Mapping]**.

   ![1. Passare alla scheda Mapping attributi.](assets/marketo-engage-activities-10.png)
...
Per qualsiasi regola appartenente a un Tipo di attività con un ID programma, il Canale del programma Marketo è determinato dal Programma. Il canale del programma viene utilizzato per la mappatura ai tuoi canali offline personalizzati, quindi devi verificare che i tuoi canali siano configurati correttamente [come indicato qui](/help/marketo-engage-programs-integration.md).

E per una qualsiasi delle regole da un Tipo di attività senza un ID programma, il primo passaggio era creare un Nome campagna. Utilizza questo nome campagna per configurare i tuoi canali online personalizzati [descritti qui](/help/channel-tracking-and-setup/online-custom-channel-setup.md).
