---
description: Panoramica dell’interfaccia Adobe Experience Cloud per gli utenti di Marketo Measure
...
![Se hai già effettuato l&#39;accesso a un prodotto Adobe Experience Cloud,](assets/unified-overview-6.png)
...
![Gestisci i domini Marketo Measure(/help/domain-management.md) senza l&#39;assistenza di Marketo Measure.](assets/unified-overview-9.png)
...
![Cerca articoli di supporto, invia ticket, fornisci feedback, il tutto dall&#39;interno di](assets/unified-overview-5.png)
...
![Coloro che hanno accesso a più prodotti Adobe possono passare facilmente](assets/unified-overview-4.png)
...
![Visualizza e interagisce direttamente con le notifiche specifiche per prodotto e gli annunci generali dei prodotti Adobe](assets/unified-overview-10.png)

![Visualizza e interagisce direttamente con le notifiche specifiche per prodotto e gli annunci generali dei prodotti Adobe](assets/unified-overview-11.png)
...
![Per modificare la lingua o altre preferenze a livello di Adobe, fai clic sull&#39;icona del tuo profilo.](assets/unified-overview-8.png)
...
![Se puoi accedere a Adobe Experience Cloud, ma vedi a](assets/unified-overview-7.png)
