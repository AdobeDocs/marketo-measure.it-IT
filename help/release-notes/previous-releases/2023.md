...
La tabella URL nel [data warehouse](/help/data-warehouse/data-warehouse-schema.md){target="_blank"} includerà ora un campo titolo pagina, oltre alle tabelle dati Web.
...
* [Nuova guida per l&#39;individuazione del dashboard](/help/marketo-measure-discover-ui/new-discover-dashboard-guide.md){target="_blank"}
* [Nozioni di base sulla dashboard](/help/marketo-measure-discover-ui/discover-dashboard-basics.md){target="_blank"}
* [Dashboard panoramica ricavi](/help/marketo-measure-discover-ui/revenue-overview-dashboard.md){target="_blank"}
* [Dashboard ricavi attribuiti](/help/marketo-measure-discover-ui/attributed-revenue-dashboard.md){target="_blank"}
* [Dashboard ROI](/help/marketo-measure-discover-ui/roi-dashboard.md){target="_blank"}
* [Dashboard Passport](/help/marketo-measure-discover-ui/passport-dashboard.md){target="_blank"}
...
![Impostazione del tipo di report Salesforce per lead/contatti con punti di contatto](assets/release-notes-2023-1.png)
...
![Colonne di report che evidenziano i campi legacy Lead e Contatta FT/LC da rimuovere](assets/release-notes-2023-2.png)

* Aggiungi campi punto di contatto:

![Colonne di report che mostrano i campi punto di contatto da aggiungere al posto dei campi FT/LC](assets/release-notes-2023-3.png)
...
![Esempio di configurazione del filtro Posizione punto di contatto](assets/release-notes-2023-4.png)

![Filtro campo data aggiornato a campi basati su punti di contatto](assets/release-notes-2023-5.png)
