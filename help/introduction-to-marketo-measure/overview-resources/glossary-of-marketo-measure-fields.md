...
Questo campo viene compilato con il nome dell’account associato all’BAT.
...
Questo campo mostra l’opportunità a cui appartiene l’BAT.
...
`2)` Se il punto di contatto proviene da un evento offline, questo campo visualizza la data e l&#39;ora impostate nella campagna Salesforce o dal campo data selezionato nelle regole di sincronizzazione della campagna.
