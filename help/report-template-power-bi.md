...
![Aprire il file Power BI del modello di reporting di Adobe Marketo Measure.](assets/marketo-bi-1.png)

È possibile trovare informazioni specifiche su server, warehouse e schema nell&#39;interfaccia utente [!DNL Marketo Measure] nella pagina delle informazioni di [!DNL Data Warehouse]. Le istruzioni per individuare questa pagina sono dettagliate [qui](/help/data-warehouse-access-reader-account.md){target="_blank"}.
...
![Per limitare i dati importati nel modello, ogni tabella è impostata](assets/marketo-bi-2.png)
...
![I filtri di data vengono applicati alla data modificata di a](assets/marketo-bi-3.png)
...
![Sono state applicate alcune trasformazioni ai dati in Power Query.](assets/marketo-bi-6.png)
...
![La maggior parte delle tabelle nel data warehouse di Marketo Measure contiene dimensioni denormalizzate](assets/marketo-bi-7.png)
...
![Le tabelle e le colonne sono state rinominate per renderle più intuitive e](assets/marketo-bi-5.png)
...
![/incolla funzioni e filtro.](assets/marketo-bi-8.png)

![/incolla funzioni e filtro.](assets/marketo-bi-11.png)
...
![Per aggiungere le funzionalità di conversione della valuta ai calcoli nel modello, abbiamo](assets/marketo-bi-10.png)
...
![La tabella Tasso di conversione archiviata in Snowflake contiene un intervallo di date](assets/marketo-bi-9.png)

## Modello di dati {#data-model}

Fai clic sull’immagine seguente per la versione di dimensioni intere.

[![Fai clic sull’immagine seguente per la versione di dimensioni intere.](assets/marketo-bi-12.png)](assets/power-model-1.png){target="_blank"}
...
![Le misure di conversione della valuta in questo modello sostituiscono un valore di 1,0](assets/marketo-bi-13.png)
...
![Le definizioni sono state aggiunte al modello Power BI per le tabelle, personalizzato](assets/marketo-bi-15.png)

![Le definizioni sono state aggiunte al modello Power BI per le tabelle, personalizzato](assets/marketo-bi-16.png)

![Le definizioni sono state aggiunte al modello Power BI per le tabelle, personalizzato](assets/marketo-bi-14.png)
