...
Ulteriori informazioni su [Marketo Measure Ultimate](/help/migration-from-tier-to-marketo-measure-ultimate.md){target="_blank"}.
...
![Da un&#39;origine, selezionare Aggiungi modelli di utilizzo dati](assets/marketo-guide-2.png)

* Seleziona un account e tutti i modelli B2B per creare dieci schemi B2B standard.

![Selezionare un account e tutti i modelli B2B per creare dieci modelli B2B standard](assets/marketo-guide-3.png)
...
1. Mappa i campi da Source allo schema.
   ...
   >[!NOTE]
   >
   >[Requisiti di integrità dei dati di Marketo Measure Ultimate](/help/data-integrity-requirement.md){target="_blank"}
...
![Opzione 1: per eseguire query direttamente dall&#39;interfaccia utente, accedere alle query](assets/marketo-guide-4.png)
...
![Gli utenti possono mappare le fasi da origini diverse.](assets/marketo-guide-5.png)
