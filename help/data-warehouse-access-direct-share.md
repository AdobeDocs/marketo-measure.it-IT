...
[!DNL Marketo Measure] potrà impostare le condivisioni dirette Snowflake solo con account situati in Azure East US 2 a causa delle attuali limitazioni di condivisione diretta Snowflake. Se i dati devono essere resi disponibili in altre aree geografiche di Snowflake, è consigliabile creare una copia dei dati in un account Snowflake che si trova in Azure East US 2 e utilizzare la funzionalità [Replica database Snowflake](https://docs.snowflake.com/en/user-guide/database-replication-intro.html){target="_blank"} per copiare i dati nell&#39;area o nell&#39;account Snowflake desiderato.
