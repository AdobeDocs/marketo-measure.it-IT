...
![Per iniziare, passare alla pagina Autenticazione di sicurezza impostazioni in](assets/compliance-resources-1.png)
...
Passa all&#39;SSO personalizzato nell&#39;applicazione [!DNL Marketo Measure]
    ...
    c. Cambiare il tipo di accesso in &quot;SSO personalizzato&quot; per avviare il processo di configurazione.
...
Imposta e mappa le impostazioni degli attributi utente in base ai rispettivi nomi, cognomi e indirizzi e-mail.
    ...
    a. Immettendo gli attributi SAML, [!DNL Marketo Measure] sarà in grado di riconoscere gli utenti in base alle informazioni passate.
    ...
    ii. Attributo nome: specificare il nome dell&#39;attributo utilizzato dal provider di identità per il nome dell&#39;utente.
...
Imposta e mappa le impostazioni del Ruolo utente sui rispettivi ruoli o gruppi classificati dal tuo IdP.
    ...
    b. Se non è stato eseguito il mapping di ruoli o gruppi, l&#39;impostazione predefinita prevede che tutti i dipendenti del provider di identità avranno accesso utente Standard.
    
    i. [!DNL Marketo Measure] Utente Standard: fornire il valore del ruolo o del gruppo (dal provider SSO) per gli utenti che devono avere accesso in sola lettura all&#39;applicazione [!DNL Marketo Measure] application.
    ii. [!DNL Marketo Measure] Utente amministratore account: fornire il valore del ruolo o del gruppo (dal provider SSO) per gli utenti che devono avere accesso amministrativo all&#39;applicazione [!DNL Marketo Measure] application. Ciò significa che il ruolo ha accesso a modificare le configurazioni e le impostazioni relative al tuo account.
    iii. Nell&#39;IdP deve essere presente un attributo con il nome esatto di &quot;gruppi&quot; che contiene i valori inseriti negli attributi &quot;Utente standard Bizible&quot; o &quot;Utente amministratore account Bizible&quot;.
    
    c. Se è necessario mappare più ruoli o gruppi a un ruolo, immettere ogni valore separato da una virgola.

![c. Se più ruoli o gruppi devono essere mappati a un ruolo,](assets/discover-control-2.png)

Verificare la configurazione Single Sign-On

    a. Prima di poter premere Salva, sarà necessario fare clic sul pulsante [!UICONTROL Test SAML Authentication] per verificare che le impostazioni siano state configurate correttamente.
...
Salva le impostazioni e indirizza i tuoi colleghi a utilizzare [!UICONTROL Single Sign On] con il nuovo URL di accesso personalizzato.
    ...
    a. Importante: una volta salvate le nuove impostazioni di autenticazione, è possibile che la sessione termini quando si passa a una nuova pagina perché l&#39;accesso degli utenti CRM è stato disabilitato e l&#39;SSO personalizzato abilitato.

![a. Importante: una volta salvate le nuove impostazioni di autenticazione, è possibile](assets/discover-control-3.png)
...
![Per i ruoli Salesforce, utilizzare il nome di ogni ruolo. Tutti i ruoli](assets/discover-control-3.png)
...
![Per i ruoli Dynamics, utilizzare il nome di ogni ruolo di protezione. Tutti](assets/discover-control-3.png)
