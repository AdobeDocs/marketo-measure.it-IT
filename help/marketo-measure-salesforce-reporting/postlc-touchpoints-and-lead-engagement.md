...
![I punti di contatto Post-Lead Creation (PostLC) di Marketo Measure sono disponibili per i clienti che utilizzano](assets/additional-functionality-1.png)
...
![I punti di contatto PostLC sono dinamici. Come lead o contatto continua a inviare](assets/additional-functionality-2.png)
...
1. Immettere il numero di punti di contatto postLC da inviare ai lead e fare clic su **[!UICONTROL Save]**.
   ...
   ![1. Inserisci il numero di punti di contatto postLC a cui inviare il push](assets/additional-functionality-3.png)
...
1. Immettere il numero di punti di contatto postLC da inviare ai contatti e fare clic su **[!UICONTROL Save]**.
   ...
   ![1. Inserisci il numero di punti di contatto postLC a cui inviare il push](assets/additional-functionality-4.png)
