---
description: Punti di contatto PostLC e coinvolgimento lead
...
![Record di lead che mostra i punti di contatto PostLC in Salesforce](assets/1.png)
...
![Elenco punti di contatto PostLC limitato a quattro invii più recenti](assets/2.png)
...
1. Immettere il numero di punti di contatto postLC da inviare ai lead e fare clic su **[!UICONTROL Save]**.
   ...
   ![Pagina Impostazioni lead per impostare il limite di punti di contatto PostLC](assets/3.png)
...
1. Immettere il numero di punti di contatto postLC da inviare ai contatti e fare clic su **[!UICONTROL Save]**.
   ...
   ![Pagina Impostazioni contatto per impostare il limite di punti di contatto PostLC](assets/4.png)
