...
1. Vai a **[!UICONTROL Setup]** > **[!UICONTROL Build]** > **[!UICONTROL Report Types]** > **[!UICONTROL New Custom Report Types]**.
   ...
   ![1. Vai a Imposta tipi di report di compilazione Nuovo](assets/new-types-1.png)
...
1. Definisci il tipo di rapporto personalizzato.
   ...
   * [!UICONTROL Deployment] > [!UICONTROL Deployment Status]: distribuito
   ...
   ![Stato distribuzione: distribuito](assets/new-types-10.jpg)
...
1. Vai a **[!UICONTROL Setup]** > **[!UICONTROL Build]** > **[!UICONTROL Report Types]** > **[!UICONTROL New Custom Report Types]**.
   ...
   ![1. Vai a Imposta tipi di report di compilazione Nuovo](assets/new-types-12.png)
...
1. Definisci il tipo di rapporto personalizzato.
   ...
   * [!UICONTROL Deployment] > [!UICONTROL Deployment Status]: distribuito
   ...
   ![Stato distribuzione: distribuito](assets/new-types-13.jpg)
...
1. Definisci il tipo di rapporto personalizzato.
   ...
   * [!UICONTROL Deployment] > [!UICONTROL Deployment Status]: distribuito
   ...
   ![Stato distribuzione: distribuito](assets/new-types-14.jpg)
