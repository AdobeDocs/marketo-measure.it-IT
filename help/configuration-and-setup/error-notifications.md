...
![Per visualizzare il messaggio di notifica completo in Marketo Measure, fare clic su Visualizza](assets/adobe-setup-1.png)
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Per assistenza nella regolazione delle allocazioni di credito API, consulta la seguente documentazione per il CRM:</p>
          ...
          <p>
          &lt;img alt="notifiche di errore 3" src="assets/error-notifications-3.png"
          </p>
      </td>
    </tr>
    <tr>
      <td>CANNOT_EXECUTE_FLOW_TRIGGER</td>
      <td>Errore durante l'esportazione CRM: CANNOT_EXECUTE_FLOW_TRIGGER : tipo di entità 'Contatto' Fornire questi dettagli all'amministratore Salesforce.
Limite superato
Il limite massimo per questa funzione è stato superato dall’utente o dall’organizzazione. ID errore: 123456</td>
      <td>Impossibile salvare il record perché non soddisfa una regola di flusso del trigger configurata nell'organizzazione Salesforce.</td>
...
La documentazione di Salesforce sui trigger di flusso <a href="https://admin.salesforce.com/blog/2023/what-is-a-record-triggered-flow#:~:text=A%20record%2Dtriggered%20flow%20allows,is%20created%20and%2For%20updated"> è disponibile qui</a>.
    ...
    <tr>
      ...
      <td>Errore durante l'esportazione CRM: CANNOT_INSERT_UPDATE_ACTIVATE_ENTITY : Tipo di entità 'Lead': Codice errore CRM: CANNOT_INSERT_UPDATE_ACTIVATE_ENTITY, Messaggio di errore CRM: System.LimitException: limite di tempo Apex CPU superato, RecordId: 0123456
      <p>
      ...
      <td>Esamina il codice del trigger che causa l’errore di inserimento/aggiornamento. Per ulteriori informazioni sui trigger, consulta la seguente documentazione di Salesforce:
        ...
        <p>
        Fornisci tutte le autorizzazioni necessarie all'<a href="/help/configuration-and-setup/how-marketo-measure-and-salesforce-interact.md">utente Marketo Measure</a>.
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Consulta il seguente <a href="/help/configuration-and-setup/how-marketo-measure-and-salesforce-interact.md">articolo di Experience League</a> per informazioni sulle autorizzazioni richieste da Marketo Measure.</td>
    </tr>
    <tr>
      ...
      <td>Per garantire la corretta configurazione, consulta i seguenti articoli della guida:
        <ul>
          <li>
            <a href="/help/adobe-analytics.md">Integrazioni Marketo Measure con Adobe Analytics</a>
          </li>
          <li>
    ...
    <tr>
      ...
      <td>Sono necessarie autorizzazioni di lettura e scrittura per tutti i campi con prefisso "bizible2__". Un elenco completo di questi campi si trova <a href="/help/configuration-and-setup/how-marketo-measure-and-salesforce-interact.md">in questo articolo</a>.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Questa autorizzazione è necessaria per gli oggetti Salesforce per poter mantenere sincronizzati Marketo Measure e Salesforce.</td>
      <td>Contatta il supporto Salesforce per assistenza nell’impostazione dell’autorizzazione replicabile sugli oggetti.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Questo errore è dovuto a diversi motivi specifici per l’organizzazione Salesforce. Di seguito sono riportati alcuni passaggi comuni per la risoluzione dei problemi che possono risolvere il problema:
        <ul>
          <li>Rivedi tutte le autorizzazioni necessarie per ogni <a href="/help/configuration-and-setup/how-marketo-measure-and-salesforce-interact.md">oggetto e campo</a>.</li>
    ...
    <tr>
      ...
      <td>Se il problema persiste, archivia un caso con Salesforce e copia i valori numerici nel messaggio di errore.</td>
    </tr>
    <tr>
      ...
      <td>Aggiorna il pacchetto alla versione più recente:
        <ul>
          <li><a href="/help/configuration-and-setup/best-practices-for-marketo-measure-crm-package.md">Best practice</a>
          </li>
