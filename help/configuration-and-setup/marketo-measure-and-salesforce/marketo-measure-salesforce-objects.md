...
![Diagramma che mostra la relazione tra gli oggetti Marketo Measure e gli oggetti Salesforce standard](assets/1-1.png)

## Buyer Touchpoint {#buyer-touchpoint}

L&#39;oggetto [!UICONTROL Buyer Touchpoint] (BT) racconta la storia di marketing di un singolo utente. Racchiude tutti i dati relativi ai punti di contatto di marketing generati da lead e contatti. BT mostra informazioni come il canale di marketing da cui proviene il punto di contatto o quale campagna pubblicitaria ha portato quel particolare lead/contatto al sito web.

L&#39;oggetto BT è visibile nelle pagine Lead e Contatti come **Elenco correlato** (vedi immagine seguente).

![Elenco correlato a Buyer Touchpoint visualizzato nelle pagine lead e contatti in Salesforce](assets/2-1.png)
...
![Record persona Marketo Measure in Salesforce che mostra la ricerca per lead/contatti e punti di contatto correlati](assets/4.png)
...
![Elenco dei test A/B di Marketo Measure correlati alle pagine Lead, Contatti e Opportunità che mostra esperimenti e varianti](assets/5.png)
