...
1. Nella colonna di opzioni di impostazione a sinistra, fare clic su **[!UICONTROL Connections]** che si trova nella sezione [!UICONTROL Integrations].
   ...
   ![Il menu Impostazioni mostra l&#39;opzione Connessioni nella sezione Integrazioni](assets/connect-marketo-measure-to-salesforce-1.png)

1. Nella sezione CRM in Connessioni fare clic su **[!UICONTROL Set Up New CRM Connection]**.

   ![Pagina Connessioni CRM con pulsante Configura nuova connessione CRM](assets/connect-marketo-measure-to-salesforce-2.png)
...
1. Viene visualizzata una finestra popup in cui viene richiesto di selezionare la connessione CRM. Fare clic su **[!UICONTROL Connect]** accanto al logo [!DNL Salesforce].
   ...
   ![Finestra popup di selezione della connessione CRM con logo Salesforce e pulsante di connessione](assets/connect-marketo-measure-to-salesforce-3.png)
...
![Impostazione limite API CRM giornaliero che mostra il campo di configurazione per la quota di credito API](assets/connect-marketo-measure-to-salesforce-4.png)
...
1. Fai clic sull’icona Blocca per modificarla.
   ...
   ![Icona di blocco per la modifica del campo limite API CRM giornaliero](assets/connect-marketo-measure-to-salesforce-5.png)

1. Inserisci un limite desiderato uguale o superiore a 100.000. Al termine, fai clic su **Salva**.

   ![Campo di input limite API CRM giornaliero con valore immesso e pulsante Salva](assets/connect-marketo-measure-to-salesforce-6.png)
