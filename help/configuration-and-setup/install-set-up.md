---
description: Installazione e configurazione del pacchetto Salesforce - [!DNL Marketo Measure]
...
1. Selezionare **[!UICONTROL Install]per tutti gli utenti**.
   ...
   ![1. Selezionare Installa per tutti gli utenti.](assets/bizible-full-1.png)

1. Una volta completata l’installazione, puoi visualizzarla.

   ![1. Una volta completata l&#39;installazione, è possibile visualizzarla.](assets/bizible-taxonomy-1.png)

Dopo aver completato l&#39;installazione, puoi aggiornare i [[!DNL Salesforce] layout di pagina](/help/configuration-and-setup/page-layout-instructions.md){target="_blank"} con i campi [!DNL Marketo Measure], se necessario.

>[!NOTE]
>
>Scopri i set di autorizzazioni [!DNL Marketo Measure] creati e [come vengono utilizzati](/help/configuration-and-setup/marketo-measure-permission-sets.md){target="_blank"}.
...
>[!MORELIKETHIS]
>
>* [Panoramica delle autorizzazioni di integrazione](/help/api-connections/integration-permissions-overview.md){target="_blank"}
>
>* [Installazione di Adobe Admin Console](/help/configuration-and-setup/adobe-admin-console-setup.md){target="_blank"}
