...
* Per ulteriori informazioni sulla relazione [!DNL Marketo Measure] con [!DNL Salesforce], vedere [questo articolo](/help/configuration-and-setup/how-marketo-measure-and-salesforce-interact.md)
...
* Viene richiesto di confermare l&#39;eliminazione. Assicurati di leggere attentamente il prompt e comprendere le conseguenze dell’eliminazione
  ...
  ![Ti viene chiesto di confermare l&#39;eliminazione. Assicurati di leggere più di](assets/salesforce-migration-1.png)
...
[Layout di pagina](/help/configuration-and-setup/page-layout-instructions.md)
...
[Nascondere i tipi di report non necessari](/help/configuration-and-setup/hiding-unnecessary-report-types.md)

[Flusso di lavoro personalizzato, se applicabile](/help/channel-tracking-and-setup/using-a-custom-revenue-amount-field.md)
