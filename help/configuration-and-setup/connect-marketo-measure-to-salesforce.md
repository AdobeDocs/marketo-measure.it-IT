...
1. Nella colonna di opzioni di impostazione a sinistra, fare clic su **[!UICONTROL Connections]** che si trova nella sezione [!UICONTROL Integrations].
   ...
   ![1. Nella colonna di opzioni di impostazione a sinistra, fare clic su](assets/bizible-full-1.png)

1. Nella sezione CRM in Connessioni fare clic su **[!UICONTROL Set Up New CRM Connection]**.

   ![1. Nella sezione CRM in Connessioni fare clic su Configura nuovo](assets/bizible-taxonomy-1.png)
...
1. Viene visualizzata una finestra popup in cui viene richiesto di selezionare la connessione CRM. Fare clic su **[!UICONTROL Connect]** accanto al logo [!DNL Salesforce].
   ...
   ![1. Viene visualizzata una finestra popup in cui viene richiesto di selezionare la connessione CRM. Fai clic su](assets/connect-salesforce-1.png)
...
![Puoi accedere a questo limite in Marketo Measure tramite: Impostazioni account](assets/connect-salesforce-2.png)
...
1. Fai clic sull’icona Blocca per modificarla.
   ...
   ![1. Fare clic sull&#39;icona Blocca per modificare.](assets/connect-salesforce-3.png)

1. Inserisci un limite desiderato uguale o superiore a 100.000. Al termine, fai clic su **Salva**.

   ![1. Inserisci un limite desiderato uguale o superiore a 100.000. Fai clic su](assets/connect-salesforce-1.png)
