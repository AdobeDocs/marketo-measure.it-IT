...
![Marketo Measure fornisce la mappatura degli ID account come funzionalità integrata. Questo](assets/adobe-setup-1.png)
...
![Sebbene la maggior parte dei client utilizzi il mapping degli ID account, Marketo Measure è in grado di eseguire l&#39;analisi](assets/adobe-setup-2.png)
...
![Oltre a esaminare semplicemente i ruoli di contatto nell&#39;opportunità, Marketo](assets/adobe-setup-3.png)
