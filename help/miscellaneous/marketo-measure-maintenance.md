...
Aggiorna la memoria su come caricare le informazioni sui costi leggendo [questo articolo](/help/marketing-spend/marketing-channel-costs.md).
...
Per ulteriori informazioni sul modello di apprendimento automatico [!DNL Marketo Measure], vedi [questo articolo](/help/advanced-features/custom-attribution-models/machine-learning-model-faq.md).
