...
i. [!DNL Marketo Measure] verifica innanzitutto se la campagna o il programma sta creando punti di contatto da una [regola di sincronizzazione della campagna](/help/channel-tracking-and-setup/custom-campaign-sync.md) creata o da una [regola di sincronizzazione del programma](/help/marketo-engage-programs-integration.md) creata oppure il valore [Abilita punti di contatto dell&#39;acquirente](/help/channel-tracking-and-setup/syncing-offline-campaigns.md) è &quot;Includi tutti i membri della campagna&quot; o &quot;Includi i membri della campagna &quot;Risponsi&quot;.&quot;
