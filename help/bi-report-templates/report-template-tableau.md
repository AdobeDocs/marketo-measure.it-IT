...
È necessario aggiornare i dati di connessione esistenti alle informazioni di connessione Snowflake specifiche. Fare clic sul pulsante [!UICONTROL Edit Connection] e seguire i passaggi descritti nella sezione [[!UICONTROL Data Connection]](#data-connection) di questa documentazione.

![Cartella di lavoro Tableau con il pulsante Modifica connessione](assets/marketo-measure-report-template-tableau-1.png)

## Connessione dati {#data-connection}

Devi impostare una connessione dati all’istanza Snowflake. A questo scopo, è necessario specificare il nome del server insieme al nome utente e alla password. I dettagli su dove trovare queste informazioni e reimpostare la password, se necessario, sono documentati [qui](/help/data-warehouse/data-warehouse-access-reader-account.md){target="_blank"}.

![Finestra di dialogo della connessione Snowflake con i campi del server e dell&#39;autenticazione](assets/marketo-measure-report-template-tableau-2.png)
...
![Campo comando SQL iniziale per la specifica dello schema](assets/marketo-measure-report-template-tableau-3.png)
...
![Menu di scelta rapida che mostra l&#39;opzione Modifica query SQL personalizzata](assets/marketo-measure-report-template-tableau-4.png)

![Finestra di dialogo Editor query SQL personalizzate in Tableau](assets/marketo-measure-report-template-tableau-5.png)

### Colonne rimosse {#removed-columns}

Per semplificare il modello dati e rimuovere i dati ridondanti e non necessari, abbiamo ridotto il numero di colonne importate in Tableau dalla tabella Snowflake originale. Le colonne rimosse includono chiavi esterne non necessarie, dati dimensionali denormalizzati meglio utilizzati tramite relazioni con altre tabelle nel modello, colonne di controllo e campi utilizzati per l&#39;elaborazione interna di [!DNL Marketo Measure]. È possibile aggiungere o rimuovere colonne in base alle esigenze aziendali modificando l&#39;elenco delle colonne importate nella sezione Select dell&#39;istruzione SQL personalizzata.
...
![Tabella opportunità con colonne del tasso di conversione](assets/marketo-measure-report-template-tableau-6.png)
...
![Tabella combinata che mostra la colonna Tipo per l&#39;identificazione entità](assets/marketo-measure-report-template-tableau-7.png)
...
![Tabella di mappatura dei nomi di segmento con nomi di categoria e personalizzati](assets/marketo-measure-report-template-tableau-8.png)
...
![SQL personalizzato con categorie di segmenti rinominate](assets/marketo-measure-report-template-tableau-9.png)

L&#39;altra opzione consiste nel rinominare le colonne direttamente nella tabella [!DNL Tableau].

![Tabella Tableau con colonne di segmenti rinominata](assets/marketo-measure-report-template-tableau-10.png)

## Modello di dati {#data-model}

Fai clic sull’immagine seguente per la versione di dimensioni intere.

[![Diagramma del modello dati Tableau che mostra le relazioni tra tabelle](assets/marketo-measure-report-template-tableau-11.png)](/help/bi-report-templates/assets/tableau-data-model.png){target="_blank"}
...
![Tabella delle dimensioni Canale e Campagna combinate](assets/marketo-measure-report-template-tableau-12.png)
...
![Campi di calcolo conversione valuta in Tableau](assets/marketo-measure-report-template-tableau-13.png)
...
![Descrizione comando che mostra le misure di conversione valuta](assets/marketo-measure-report-template-tableau-14.png)
...
![Definizioni dei campi nel modello Tableau con descrizioni](assets/marketo-measure-report-template-tableau-15.png)
