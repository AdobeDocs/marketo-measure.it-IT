...
![Il primo passaggio consiste nel scaricare il foglio di calcolo del canale personalizzato da](assets/online-channels-1.png)

Il foglio di calcolo è composto da sette colonne:

![Il foglio di calcolo contiene sette colonne:](assets/online-channels-2.png)
...
![Le righe rappresentano le regole e l&#39;ordine in cui Marketo Measure](assets/online-channels-3.png)
...
![Marketo Measure viene fornito con 12 canali predefiniti per il tuo utilizzo. Questi](assets/online-channels-4.png)
...
![Ogni parametro o componente della regola è mappato separatamente al](assets/online-channels-5.png)
...
![Il canale predefinito &#39;Altro&#39; esiste per rilevare dati che non soddisfano](assets/online-channels-6.jpg)
