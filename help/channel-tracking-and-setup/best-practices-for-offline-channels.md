---
description: Linee guida sulle best practice per i canali offline per gli utenti di Marketo Measure
...
> [Sincronizzazione campagna personalizzata - Sincronizzazione app](/help/channel-tracking-and-setup/custom-campaign-sync.md)
> [Sincronizzazione delle campagne offline - Sincronizzazione CRM](/help/channel-tracking-and-setup/syncing-offline-campaigns.md)
> [Membri campagna e campagna offline - Sincronizzazione CRM](/help/channel-tracking-and-setup/campaigns-and-campaign-members.md)
> [Date di sincronizzazione campagna - Sincronizzazione CRM](/help/channel-tracking-and-setup/campaign-sync-dates.md)
> [Configurazioni per più tipi di record campagna](/help/channel-tracking-and-setup/configurations-record-types.md)
> [Creazione di una visualizzazione elenco campagne](/help/channel-tracking-and-setup/creating-a-campaign-list-view-for-salesforce-campaigns.md)
