...
![Il pacchetto Marketo Measure Salesforce includerà un campo etichettato](assets/dynamics-lists-1.png)

Le opzioni disponibili nell’elenco a discesa sono:

![Opzioni disponibili nell&#39;elenco a discesa:](assets/dynamics-lists-10.png)
...
![Se prima di utilizzare Marketo Measure si utilizzava una piattaforma di automazione marketing](assets/dynamics-lists-2.png)
...
![Potrebbe essere necessario se un elenco è stato caricato giorni/settimane/mesi dopo un](assets/dynamics-lists-4.png)
...
![La data del punto di contatto per l&#39;aggiornamento in blocco è inclusa nel Marketo installato](assets/dynamics-lists-5.png)
...
![Una ricerca non funziona, visualizzata in](assets/legacy-processes-10.png)
...
![Dopo aver impostato la data e l&#39;ora, fare clic sul pulsante Aggiorna selezionati](assets/dynamics-lists-6.png)
