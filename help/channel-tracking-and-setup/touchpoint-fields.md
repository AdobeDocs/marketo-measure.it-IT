---
description: Linee guida sui campi punto di contatto per gli utenti di Marketo Measure
...
![Dal menu Impostazioni Marketo Measure, passare ai campi punto di contatto](assets/touchpoint-fields-1.png)
...
![Sono presenti campagne create per una promozione di &quot;fine estate&quot;](assets/touchpoint-fields-2.png)
...
![Per estrarre il valore 10, è necessario definire il valore come &quot;BZ=\d{2}-\d{2}-\d{2}-\d{2}-(\d{2})&quot;](assets/touchpoint-fields-3.png)
...
![Sono presenti campi separati nell&#39;oggetto Opportunity per Segmentc e Gradec](assets/touchpoint-fields-4.png)
...
![La possibilità di creare segmenti utilizzando i campi punto di contatto è disponibile con questo](assets/touchpoint-fields-5.png)
...
![La configurazione sarà simile alla schermata seguente. Il Nome Del Segmento](assets/touchpoint-fields-6.png)

La regola fa riferimento allo stesso campo punto di contatto e cerca valori &quot;non uguali a null&quot;.

![La regola fa riferimento allo stesso campo punto di contatto e cerca i valori che](assets/touchpoint-fields-7.png)
...
È necessario un ulteriore lavoro per esporre i nuovi campi nello schema Data Warehouse [!DNL Marketo Measure]. Al momento, i campi sono esposti tramite impostazioni e configurazione, in modo da poter utilizzare i campi punto di contatto nella creazione di segmenti o nella creazione di regole per l’eliminazione dei punti di contatto.
...
![È disponibile uno strumento online (https://regex101.com/(https://regex101.com/){target="blank"}) che puoi eseguire e testare](assets/touchpoint-fields-8.png)

![È disponibile uno strumento online (https://regex101.com/(https://regex101.com/){target="blank"}) che puoi eseguire e testare](assets/touchpoint-fields-9.png)
