---
description: Linee guida per l’installazione di canali personalizzati offline per gli utenti di Marketo Measure
...
![Il foglio di calcolo ha tre colonne:](assets/offline-channels-1.png)
...
![I tipi di campagna SFDC verranno visualizzati nella scheda Canale offline, elencata](assets/offline-channels-10.jpg)
...
![È qui che puoi creare la mappatura Canale/Sottocanale in](assets/offline-channels-11.png)
...
![Di seguito è riportato un esempio di logica che Marketo Measure non avrebbe](assets/offline-channels-12.png)
...
![Nello scenario precedente, si desidera creare una campagna univoca](assets/offline-channels-13.png)
...
Ulteriori informazioni sulla [sincronizzazione offline [!DNL Salesforce] Campagne con [!DNL Marketo Measure]](/help/channel-tracking-and-setup/syncing-offline-campaigns.md).
...
>
>* [Integrazione dei programmi Marketo Engage](/help/marketo-engage-programs-integration.md){target="_blank"}
