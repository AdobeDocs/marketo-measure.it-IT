...
1. Passare all&#39;oggetto in cui si trova il campo personalizzato e fare clic sul pulsante **[!UICONTROL Set History Tracking]**.
   ...
   ![1. Vai all&#39;oggetto in cui si trova il campo personalizzato e fai clic su](assets/custom-models-1.png)

1. Seleziona i campi in cui desideri tenere traccia delle modifiche.

   ![1. Selezionare i campi in cui si desidera tenere traccia delle modifiche.](assets/custom-models-10.png)
