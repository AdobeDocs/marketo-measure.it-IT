---
description: Linee guida per Dynamics Campaigns e Marketing Lists per gli utenti di Marketo Measure
...
![Quando i lead o i contatti vengono aggiunti direttamente a una campagna, vengono immessi](assets/dynamics-lists-1.png)
...
![Marketo Measure non supporta i valori di risposta personalizzati.](assets/dynamics-lists-2.png)

Di seguito sono riportati i valori di risposta stock per la risposta alla campagna:

![Valori di risposta stock per la risposta alla campagna:](assets/dynamics-lists-3.png)
...
![Un esempio comune che utilizza questo campo è per gli eventi in cui un elenco](assets/dynamics-lists-4.png)
...
![Per abilitare un elenco di marketing per i punti di contatto, esiste un&#39;impostazione separata](assets/legacy-processes-10.png)
...
![La data del punto di contatto per un elenco di marketing è in genere il ListMember creato](assets/dynamics-lists-6.png)
...
![Per ogni tipo di campagna, può essere mappato a un canale e](assets/dynamics-lists-7.png)

![Per ogni tipo di campagna, può essere mappato a un canale e](assets/dynamics-lists-8.png)
