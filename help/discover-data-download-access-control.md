---
description: Scopri come controllare quali utenti possono scaricare i dati da Discover dashboards
...
1. Fare clic su **[!UICONTROL Data Access]** in [!UICONTROL Security].
   ...
   ![1. Fare clic su Accesso ai dati in Protezione.](assets/compliance-resources-1.png)

1. Fai clic sull’elenco a discesa e seleziona l’opzione appropriata per la console.

   ![1. Fare clic sull&#39;elenco a discesa e selezionare l&#39;opzione appropriata per la console.](assets/discover-control-2.png)

| Opzione | Accesso ai download |
| --- | --- |
| Tutti gli utenti | Tutti gli utenti possono scaricare i dati, inclusi i formati PDF e CSV. |
| Solo per utenti amministratori | Solo gli utenti amministratori possono scaricare i dati, inclusi i formati PDF e CSV. |
| Nessuna | Nessuno può scaricare i dati, inclusi i formati PDF e CSV. |

1. Al termine, fai clic su **[!UICONTROL Save]**.

   ![1. Al termine, fai clic su Salva.](assets/discover-control-3.png)
