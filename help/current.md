---
description: Note sulla versione corrente - Guida per gli utenti di Marketo Measure
...
![È ora possibile creare segmenti utilizzando i campi Campaign e Campaign Member](assets/release-notes-2.png)
...
* Nuova documentazione: [Impostazione gestione errori per esportazioni CRM](/help/configuration-and-setup/crm-error-handling.md)
...
* [Fasi e punti di contatto del boomerang](/help/channel-tracking-and-setup/boomerang-stages-and-touchpoints.md){target="_blank"}
* [Impostazione delle fasi del boomerang](/help/channel-tracking-and-setup/setting-up-boomerang-stages.md){target="_blank"}
* [Scenari Boomerang Stage](/help/channel-tracking-and-setup/boomerang-stage-scenarios.md){target="_blank"}
...
* [Cookie di Marketo Measure](/help/marketo-measure-tracking/marketo-measure-cookies.md){target="_blank"}
...
Per aiutarti ad adattarti a questa modifica, [abbiamo creato la documentazione](/help/configuration-and-setup/error-notifications.md){target="_blank"} con descrizioni chiare degli errori e passaggi completi per la risoluzione dei problemi.

**Azione richiesta per l&#39;integrazione LinkedIn**
