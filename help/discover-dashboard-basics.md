---
description: Introduce l’interfaccia del dashboard Discover, i filtri, le azioni di drilling, i filtri incrociati, le esportazioni e la modalità di attivazione
...
![Passa il puntatore del mouse sull&#39;angolo superiore destro di un oggetto visivo per visualizzare un elenco di sola lettura di](assets/discover-3b-1.png)
...
![Attivare il drill-down facendo clic sulla singola freccia verso il basso, evidenziata da un colore grigio](assets/discover-basics-8.png)

Per espandere un campo alla volta, attivare l&#39;icona di espansione e selezionare un elemento visivo, ad esempio una barra.

![Per espandere un campo alla volta, attivare il drill-down](assets/discover-basics-2.gif)

Utilizzare l&#39;icona di espansione a doppia freccia per avanzare al livello gerarchico successivo.

![Utilizzare l&#39;icona di espansione a doppia freccia per passare alla gerarchia successiva](assets/discover-basics-1.gif)

Utilizza l’icona a forma di fork per aggiungere un ulteriore livello gerarchico nella vista corrente.

![Utilizza l&#39;icona a forma di fork per aggiungere un ulteriore livello di gerarchia nel tuo](assets/discover-basics-12.gif)
...
![Per esplorare i dati dietro l&#39;elemento visivo, fare clic con il pulsante destro del mouse sull&#39;elemento visivo e](assets/discover-basics-13.gif)
...
![Per esportare i dati sottostanti da un oggetto visivo, posiziona il cursore del mouse sul relativo elemento in alto a destra](assets/discover-basics-6.gif)
...
![Per ingrandire un elemento visivo o una sezione specifica, passa il puntatore del mouse su](assets/discover-basics-5.gif)
...
![Selezionando un valore o un&#39;etichetta dell&#39;asse in una visualizzazione verrà applicato un filtro incrociato all&#39;altra](assets/discover-basics-3.gif)
...
![Le descrizioni comandi offrono ulteriori dettagli sui dati visualizzati. Passa il cursore sopra un elemento visivo](assets/discover-basics-4.gif)
