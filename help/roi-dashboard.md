...
![ROI realizzato: ricavi attribuiti realizzati divisi per i costi nella data filtrata](assets/roi-dashboard-9.png)
...
![Sono presenti canali o sottocanali esterni con valori insolitamente alti o bassi](assets/roi-dashboard-8.png)
...
![In che modo la tendenza del ROI realizzato si relaziona con un marketing significativo](assets/roi-dashboard-7.png)
...
![Come sono evoluti i costi di un canale specifico nel tempo?](assets/roi-dashboard-6.png)
...
![Quali percorsi di marketing (canale, sottocanale o campagna) sembrano sottofinanziati rispetto ad altri?](assets/roi-dashboard-5.png)
...
>[!MORELIKETHIS]
>
>* [Nozioni di base sulla dashboard](/help/discover-dashboard-basics.md){target="_blank"}
>* [Criteri di visibilità dei dati del dashboard](/help/dashboard-data-visibility-policy.md){target="_blank"}
