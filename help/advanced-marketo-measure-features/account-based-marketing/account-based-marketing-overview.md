...
Per istruzioni dettagliate sulla configurazione di ABM nell&#39;istanza [!DNL Salesforce], passare a [Configurazione del layout di pagina ABM in Salesforce](/help/advanced-marketo-measure-features/account-based-marketing/account-based-marketing-overview.md#setting-up-abm-page-layout-in-salesforce){target="_blank"}.
