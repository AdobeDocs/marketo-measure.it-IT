---
description: Guida all’integrazione del tracciamento delle chiamate per gli utenti di Marketo Measure
...
![&quot;Tracciamento chiamate&quot; in senso generale è un prodotto di aziende come](assets/other-resources-6.png)
...
![Con l&#39;integrazione, puoi vedere che la sessione Web è stata effettivamente](assets/other-resources-4.png)

## Come funziona {#how-it-works}

CallTrackingMetrics deve completare un lavoro di sviluppo affinché questo funzioni. Con il JavaScript inserito sul sito, CallTrackingMetrics può acquisire `_biz_uid` dal cookie [!DNL Marketo Measure]. Questo &quot;BizibleId&quot; viene quindi memorizzato da CallTrackingMetrics.
...
![Di seguito è riportato un esempio di record Attività con BizibleId](assets/other-resources-5.png)
...
![Il tipo di punto di contatto &quot;Chiamata&quot; è stato estratto dall&#39;attività, da](assets/marketo-engage-activities-01.png)
...
![I valori dei tipi di punto di contatto inviati in genere da Marketo Measure sono Visita Web,](assets/other-resources-1.png)
