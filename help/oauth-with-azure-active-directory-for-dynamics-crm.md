...
1. Fare clic su **[!UICONTROL App Registrations]** nel menu a sinistra.
   ...
   ![1. Fare clic su Registrazioni app nel menu a sinistra.](assets/microsoft-guide-2.png)

1. Fai clic su **[!UICONTROL New Registration]** in alto.

   ![1. Fare clic su Nuova registrazione nella parte superiore.](assets/microsoft-guide-3.png)
...
1. Fare clic su **[!UICONTROL Authentication]** nel menu a sinistra.
   ...
   ![1. Fare clic su Autenticazione nel menu a sinistra.](assets/microsoft-guide-4.png)
...
1. Aggiungere gli URL di reindirizzamento [!DNL Marketo Measure]: `https://apps.bizible.com/OAuth2` e `https://apps.bizible.com/OAuth2?identityOnly=true` all&#39;elenco degli URL di reindirizzamento.
   ...
   ![1. Aggiungi gli URL di reindirizzamento di Marketo Measure: https://apps.bizible.com/OAuth2 e https://apps.bizible.com/OAuth2?identityOnly=true a](assets/microsoft-guide-5.png)
...
1. Da qui immettere &quot;[!UICONTROL enterprise]&quot; nella casella di ricerca e fare clic su **[!UICONTROL Enterprise Applications]**.
   ...
   ![1. Da qui, immettere &quot;enterprise&quot; nella casella di ricerca e fare clic su](assets/microsoft-guide-7.png)
...
1. Nella scheda Autorizzazioni fare clic su **[!UICONTROL Grant Admin Consent for (instance name)]**.
   ...
   ![1. Dalla scheda Autorizzazioni, fai clic su Concedi il consenso dell&#39;amministratore per (istanza](assets/microsoft-guide-8.png)

1. Fai clic su **[!UICONTROL Accept]**.

   ![1. Fare clic su Accetta.](assets/microsoft-guide-9.png)
...
1. Quando configuri la tua connessione Dynamics per la prima volta, segui i passaggi 1-5 della sezione &quot;CRM come provider di dati&quot; in [questo articolo](/help/microsoft-dynamics-crm-installation-guide.md).
...
1. Quando si fa clic sulla chiave, viene visualizzato un pop-up in cui viene richiesto di immettere l&#39;ID client, il segreto client e l&#39;URI dell&#39;ID applicazione, in modo analogo al flusso di iscrizione.
   ...
   ![1. Quando si fa clic sulla chiave, viene visualizzato un pop-up e si è](assets/microsoft-guide-12.png)
