...
* Se viene trovato un reindirizzamento di terze parti in un modello di tracciamento come Kenshoo o Marin, [!DNL Marketo Measure] non intraprenderà alcuna azione. Devi invece [aggiungere [!DNL Marketo Measure] parametri allo strumento di terze parti nel tuo account](/help/api-connections/how-bid-management-tools-affect-marketo-measure.md){target="_blank"}.
