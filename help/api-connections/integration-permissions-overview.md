---
description: Panoramica delle autorizzazioni di integrazione per gli utenti di Marketo Measure
...
I punti di contatto creati e altri dati vengono scritti in campi bizzarri personalizzati in Account, Campaign, CampaignMember, Case, Contact, Lead e Opportunity.</td>
    <td><b>Autorizzazioni utente connesso a Salesforce (obbligatorio)</b>
    <p>
    <b>Set di autorizzazioni per l'amministratore di Marketo Measure per l'utente dedicato:</b> Consenti all'amministratore di SFDC di eseguire operazioni CRUD sugli oggetti marketo di misura.
    <br>
...
È necessario l’accesso in LETTURA per qualsiasi campo delle entità Campaign, CampaignResponse ed List che il cliente desidera utilizzare per la sincronizzazione dei membri di Campaign/MarketingList.
  ...
  <tr>
    ...
    <td>Ci integriamo con Facebook per:
<p>
...
<br>
<li>Comunicare con le persone e consentire loro di accedere all’app con l’indirizzo e-mail associato al loro profilo di Facebook.</li></td>
  </tr>
  <tr>
    <td>LinkedIn</td>
...
<p>
  ...
  <tr>
    ...
    <td></td>
    <td><a href="/help/marketo-measure-tracking/data-collected-by-javascript.md">Dati raccolti da bizible.js</a>.</td>
    <td></td>
  </tr>
</tbody>
</table>
